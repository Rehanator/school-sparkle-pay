...
type DockProviderProps = { children: React.ReactNode; value: DocContextType };
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          'mx-auto flex w-fit gap-4 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 px-4 dark:bg-neutral-900/80',
          className,
        )}
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute top-full left-1/2 mt-4 w-fit whitespace-pre rounded-md border border-gray-200 bg-gray-100 px-2 py-0.5 text-xs text-neutral-700 shadow-lg dark:border-neutral-800 dark:bg-neutral-900 dark:text-white',
            className,
          )}
          role="tooltip"
          style={{ x: '-50%' }}
